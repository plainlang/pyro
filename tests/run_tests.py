...
#
# Everything is compared as bytes and every child process is run with sys.executable, so the
# suite proves the same thing on every platform the skill claims to support - which is the
# point of the exercise. No shell is spawned anywhere.
#
